    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return _axios.default.post('http://localhost:8000/api/v1/users/signup', data);
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"postHouse.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postHouse = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var postHouse = exports.postHouse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(title, address, rentAmount, description, isAvailable) {
    var data, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _axios.default.post('http://localhost:8000/api/v1/house/', data);
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'House added succesfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
  ...
  return function postHouse(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var _postHouse = require("./postHouse");
var logoUrl = document.querySelector('.logoUrl');
var loginForm = document.querySelector('.form--login');
var logoutBtn = document.querySelector('.logoutBtn');
var signupForm = document.querySelector('.signupForm');
var postHouseForm = document.querySelector('.postHouseForm');
if (logoUrl) {
...
if (postHouseForm) {
  postHouseForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _postHouse.postHouse)(title, address, rentAmount, description, isAvailable);
  });
}
},{"./login":"login.js","./postHouse":"postHouse.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
